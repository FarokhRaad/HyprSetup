...
sddm_theme_tpl="/usr/share/HyprSetup-hyprland/sddm/theme.conf"
if [ -f $HOME/.config/HyprSetup/settings/sddm/theme.conf ]; then
    sddm_theme_tpl="$HOME/.config/HyprSetup/settings/sddm/theme.conf"
...
sudo cp /usr/share/HyprSetup-hyprland/sddm/sddm.conf /etc/sddm.conf.d/
