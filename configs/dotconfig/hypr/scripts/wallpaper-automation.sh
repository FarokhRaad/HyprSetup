...
sec=$(cat ~/.config/HyprSetup/settings/wallpaper-automation.sh)
...
if [ ! -f ~/.config/HyprSetup/cache/wallpaper-automation ] ;then
    touch ~/.config/HyprSetup/cache/wallpaper-automation
    ...
    rm ~/.config/HyprSetup/cache/wallpaper-automation
