...
# Screenshot Filename
source ~/.config/HyprSetup/settings/screenshot-filename.sh

# Screenshot Folder
source ~/.config/HyprSetup/settings/screenshot-folder.sh

# Screenshot Editor
export GRIMBLAST_EDITOR="$(cat ~/.config/HyprSetup/settings/screenshot-editor.sh)"
