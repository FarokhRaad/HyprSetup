...
if [ -f ~/.config/HyprSetup/settings/wallpaper_cache ]; then
    use_cache=1
...
force_generate=0
generatedversions="$HOME/.config/HyprSetup/cache/wallpaper-generated"
waypaperrunning=$HOME/.config/HyprSetup/cache/waypaper-running
cachefile="$HOME/.config/HyprSetup/cache/current_wallpaper"
blurredwallpaper="$HOME/.config/HyprSetup/cache/blurred_wallpaper.png"
squarewallpaper="$HOME/.config/HyprSetup/cache/square_wallpaper.png"
rasifile="$HOME/.config/HyprSetup/cache/current_wallpaper.rasi"
blurfile="$HOME/.config/HyprSetup/settings/blur.sh"
defaultwallpaper="$HOME/wallpaper/default.jpg"
wallpapereffect="$HOME/.config/HyprSetup/settings/wallpaper-effect.sh"
blur="50x30"
blur=$(cat $blurfile)
